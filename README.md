...
| <img src="https://avatars.githubusercontent.com/u/38549082?s=200&v=4" height="42" alt="Scoop"> | **Scoop**<br>`scoop install guchho` | 🚧 Coming Soon |
| <img src="https://raw.githubusercontent.com/microsoft/winget-cli/refs/heads/master/.github/images/WindowsPackageManager_Assets/ICO/PNG/_40.png" height="42" alt="WinGet"> | **WinGet**<br>`winget install Guchho.Guchho` | 🚧 Coming Soon |
| <img src="https://brew.sh/assets/img/homebrew.svg" height="42" alt="Homebrew"> | **Homebrew**<br>`brew install guchho` | 📅 Planned |
| <img src="https://upload.wikimedia.org/wikipedia/commons/c/c2/GitHub_Invertocat_Logo.svg" height="42" alt="GitHub"> | **GitHub**<br>`bash scripts/build.sh` | ✅ Download the ZIP archive, extract it, and install it manually on your operating system. |
